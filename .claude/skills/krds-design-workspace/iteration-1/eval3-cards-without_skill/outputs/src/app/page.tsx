                  ...
                  <li key={spot.hubTatsCd}>
                    ...
                    >
                      <div className="flex items-center justify-between gap-2">
                        <Badge color="primary" variant="filled" size="small" rounded>
                          {spot.hubRank}위
                        </Badge>
                        <Badge color="gray" variant="outline" size="small">
    ...
    <div className="mt-4">
      ...
      <ul className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
        {filtered.map((spot) => (
          ...
          >
            <div className="flex items-center justify-between gap-2">
              <Badge color="secondary" variant="filled" size="small" rounded>
                연관 {spot.rlteRank}위
              </Badge>
              <Badge color="gray" variant="outline" size="small">
            ...
            <h3 className="mt-1 font-semibold">{spot.rlteTatsNm}</h3>
            <p className="text-sm text-gray-500">
