...
CSS globally — in a Next.js App Router project that's the root layout:
...
Only import this once at the root. Importing it again per-page/per-component doesn't break
anything but is redundant.
